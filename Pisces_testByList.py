...
MODEL = "./model/pisces-model_"+"final"+".ckpt"
...
def cal_distance(model1, model2):
    a_b = tf.reduce_sum(tf.reshape(tf.reduce_prod(tf.concat([tf.reshape(model1,(1,-1)), tf.
                                                            reshape(model2,(1,-1))],0),0),(B,P)),1,keep_dims=True)
...
def get_batch( label, graph_str1, graph_str2, feature_str1, feature_str2, num1, num2, max_num, father_str1,
               father_str2, child_str1, child_str2):
...
list_train_num1, list_train_num2, list_train_max, list_train_call_father_1, list_train_call_father_2, \
...
batch_valid_call_father_1, batch_valid_call_father_2, batch_valid_call_child_1, batch_valid_call_child_2 \
...
with tf.Session() as sess:
    ...
    for m in range(total_batch):
        ...
        test_max, test_call_father_1, test_call_father_2, test_call_child_1, test_call_child_2 \
            = sess.run([batch_test_label, batch_test_adj_matrix_1, batch_test_adj_matrix_2, batch_test_feature_map_1,
                        batch_test_feature_map_2, batch_test_num1, batch_test_num2, batch_test_max,
                        batch_test_call_father_1, batch_test_call_father_2, batch_test_call_child_1, batch_test_call_child_2])
        y, graph_1, graph_2, feature_1, feature_2, v_num_1, v_num_2, father_1, father_2, child_1, child_2\
            = get_batch(test_label, test_adj_matrix_1, test_adj_matrix_2, test_feature_map_1, test_feature_map_2,test_num1, test_num2,
                        test_max, test_call_father_1, test_call_father_2, test_call_child_1, test_call_child_2)
        predict = dis.eval(feed_dict={
            graph_left: graph_1, feature_left: feature_1, v_num_left: v_num_1, graph_right: graph_2, feature_right: feature_2,
            v_num_right: v_num_2, father_left: father_1, father_right: father_2, child_left: child_1, child_right: child_2,
